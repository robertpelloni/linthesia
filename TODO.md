...
- [x] Investigate FluidSynth: `libfluidsynth-dev` is missing from the environment. `FluidSynthMidiDriver` exists as a placeholder. We need to install the package or link to a local static build.
